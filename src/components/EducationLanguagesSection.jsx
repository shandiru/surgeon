        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-[#c3eefa] mx-auto lg:mx-0 max-w-xl lg:max-w-none text-center lg:text-left">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-[#c3eefa] mx-auto lg:mx-0 max-w-xl lg:max-w-none text-center lg:text-left">
                ...
                <p className="text-[#5a9bb8] font-medium">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-[#c3eefa] mx-auto lg:mx-0 max-w-xl lg:max-w-none text-center lg:text-left">
                ...
                <p className="text-[#5a9bb8] font-medium">
                  The Maharaja Sayjirao University of Baroda, India
                </p>
          ...
          <div className="bg-white text-card-foreground flex flex-col gap-6 rounded-xl border shadow-sm p-8">
            ...
            <div className="px-6 text-center">
              <div className="space-x-0 space-y-4 sm:space-y-0 sm:space-x-4">
                <span className="inline-flex items-center justify-center rounded-md border font-medium w-fit text-lg px-6 py-2">
                  English
                </span>
                <span className="inline-flex items-center justify-center rounded-md border font-medium w-fit text-lg px-6 py-2">
                  Hindi
