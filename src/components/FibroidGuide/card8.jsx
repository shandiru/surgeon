  ...
  return (
    <div className="space-y-6 pb-10 px-3">
      <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        {/* Self-Care Tips Card */}
        <div className="bg-white text-black flex flex-col gap-6 rounded-2xl py-8 px-6 shadow-md hover:shadow-lg hover:-translate-y-2 transition-all duration-300 active:scale-[0.98]">
          <div className="flex items-center gap-3">
            <Leaf className="text-3xl text-primary-pink" />
            <h3 className="font-bold text-xl md:text-2xl text-primary-pink">Self-Care Tips</h3>
          </div>
        ...
        <div className="bg-white text-black flex flex-col gap-6 rounded-2xl py-8 px-6 shadow-md hover:shadow-lg hover:-translate-y-2 transition-all duration-300 active:scale-[0.98]">
          <div className="flex items-center gap-3">
            ...
            <h3 className="font-bold text-xl md:text-2xl text-primary-pink">Support & Follow-Up</h3>
          </div>
