...
const VaginalGuide = ({ activeButton }) => {
  ...
  return (
    <div className="text-center mb-8 px-4 sm:px-6 md:px-8 lg:px-16">
      {/* Tag and Title */}
      <div className="inline-flex mt-10 bg-[#FF4B8B]/10 text-black items-center gap-2 px-4 py-2 rounded-full mb-4">
        <svg
      ...
      {/* Main Title */}
      <h1 className="text-hero text-balance mb-4 text-[#FF4B8B]">Understanding Vaginal Cancer</h1>
      ...
      <div className="mt-6 max-w-md mx-auto">
        <div className="flex justify-between items-center mb-2">
          <span className="text-sm text-muted-foreground text-black">Your Progress</span>
