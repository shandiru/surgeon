        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all hover:shadow-2xl">
              <div className="p-6 lg:p-8">
                ...
                <div className="flex flex-wrap items-center gap-4 mb-6">
                  ...
                  <span className="text-black font-medium">{event.shortLocation}</span>
                </div>
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <a href={event.joinUrl} target='_blank' rel="noopener noreferrer" className="flex-1 md:flex-none px-8 py-3 bg-primary-pink text-white rounded-xl font-semibold transition-all shadow-lg text-center">
                    Join Event
                  </a>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8">
              <h2 className="text-2xl font-bold text-black mb-4 border-b-2 border-primary-pink pb-2 inline-block">About Event</h2>
              <p className="text-black leading-relaxed">{event.about}</p>
            </div>

            {/* Speakers */}
            <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8">
              <h2 className="text-2xl font-bold text-black mb-6 border-b-2 border-primary-pink pb-2 inline-block">Who's Speaking?</h2>
            ...
            {/* FAQs */}
            <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8">
              <h2 className="text-2xl font-bold text-black mb-6 border-b-2 border-primary-pink pb-2 inline-block">FAQ's</h2>
              <div className="space-y-3">
                {event.faqs.map((faq, index) => (
                  <div key={index} className="border border-primary-pink/50 rounded-xl overflow-hidden">
                    <button onClick={() => setOpenFaq(openFaq === index ? -1 : index)} className="w-full flex items-center justify-between p-4 bg-primary-pink/20 hover:bg-primary-pink/30 transition-all">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden sticky top-6">
              <div className="bg-primary-pink p-4 text-white text-xl font-bold">Who Host this Event</div>
              <div className="p-6">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-black">{event.organizers[activeOrganizer].name}</h3>
                    <p className="text-sm text-primary-pink">Posted {event.organizers[activeOrganizer].postedDays} days ago</p>
                  </div>
                </div>
                <div className="space-y-3 mb-6">
                   <div className="flex items-center gap-2 text-sm text-black"><MapPin size={16} color="#FF4B8B"/> {event.organizers[activeOrganizer].location}</div>
                   <div className="flex items-center gap-2 text-sm text-black"><Mail size={16} color="#FF4B8B"/> {event.organizers[activeOrganizer].email}</div>
                </div>
