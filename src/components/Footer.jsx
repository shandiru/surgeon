      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="grid md:grid-cols-3 gap-8 text-sm md:text-base">
          ...
          <div className="footer-col">
            ...
            <div className="flex gap-3 mt-4">
              {/* Email */}
              <a href="mailto:info@example.com" className="bg-white p-2 rounded-md hover:bg-pink-50 transition" aria-label="Email">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#b0184d]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              ...
              {/* Phone */}
              <a href="tel:+441234567890" className="bg-white p-2 rounded-md hover:bg-pink-50 transition" aria-label="Phone">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#b0184d]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              ...
              {/* Location */}
              <a href="https://www.google.com/maps?q=Nottingham+University+Hospital" target="_blank" rel="noopener noreferrer" className="bg-white p-2 rounded-md hover:bg-pink-50 transition" aria-label="Location">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#b0184d]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        <div className="footer-bottom border-t border-white/40 mt-10 pt-6 text-center text-sm text-white/80">
          ...
          <p className="mt-3 text-white/70">
            Powered by{' '}
            <a href="https://www.ansely.co.uk/" target="_blank" rel="noopener noreferrer" className="underline hover:text-white">
              Anlsey
            </a>
          </p>
        </div>
