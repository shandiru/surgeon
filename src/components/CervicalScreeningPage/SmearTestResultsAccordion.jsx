  ...
  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6 md:px-12">
        <div className="bg-white text-primary-pink flex flex-col gap-8 rounded-2xl border border-gray-200 p-10 shadow-lg max-w-8xl mx-auto transition hover:shadow-xl">
          {/* Header */}
