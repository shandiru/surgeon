      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-10">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-primary-pink">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm
                            ...
                            hover:border-primary-pink hover:-translate-y-2 active:scale-[0.98]">
              <h3 className="text-xl font-semibold text-primary-pink mb-4">
                Under 25
              </h3>
              ...
              <p className="text-sm text-black mt-4">
                <strong className="text-primary-pink">Note:</strong> See a doctor if you have unusual bleeding or bleeding after sex
              </p>
            </div>
