            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              ...
              <div className="space-y-6 text-center md:text-left order-2 md:order-1">
                ...
                <p className="text-body-large md:text-lg text-black leading-relaxed">
                  Explore the pros and cons of robotic surgery, discover Ketan's
                  extensive experience as a robotic surgeon, and learn about his
                  current work as Medical Director in the hospital and his
                  teaching of robotic surgery techniques across Europe.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start pt-2">
                  ...
                  <Link
                    to="/#about"
                    className="cursor-pointer inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg border-2 border-primary-pink text-primary-pink font-semibold text-button hover:bg-primary-pink/10 transition-all duration-300"
                  >
