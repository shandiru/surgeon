...
const ColposcopyGuide = () => {
  return (
    <div className="text-center mb-8">
      ...
      {/* Main Title */}
      <h1 className="text-4xl font-bold text-balance mb-4 text-[#BB125B]">Understanding Colposcopy</h1>
      <p className="text-xl text-muted-foreground text-balance text-[#BB125B]">What it is, why it's done, and what to expect</p>

      {/* Progress Bar */}
      <div className="mt-6 max-w-md mx-auto">
        <div className="flex justify-between items-center mb-2">
          <span className="text-sm text-muted-foreground text-[#BB125B]">Your Progress</span>
          <span className="text-sm font-medium text-[#BB125B]">0/7 sections</span>
        </div>
