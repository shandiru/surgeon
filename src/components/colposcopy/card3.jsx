...
const Colposcopycard3 = () => {
  return (
    <div className="space-y-6">
      {/* Card Container */}
      <div className="bg-card max-w-5xl mx-auto mb-5 text-card-foreground flex flex-col gap-6 rounded-xl border py-6 shadow-sm animate-in slide-in-from-right-5 duration-300">
        {/* Card Header */}
