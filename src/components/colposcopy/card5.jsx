      ...
      <div className="max-w-sm sm:max-w-2xl lg:max-w-5xl text-black mx-auto mb-10 flex flex-col gap-6 rounded-xl border border-light-pink-2 py-6 shadow-sm animate-in slide-in-from-right-5 duration-300">
        ...
        <div className="px-6 space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-4 bg-primary/10 rounded-lg border border-primary/20 hover:z-50 transition-all duration-300 hover:bg-light-pink-1 hover:shadow-xl hover:border-primary-pink active:bg-light-pink-1 active:shadow-lg active:border-primary-pink hover:scale-105 active:scale-100">
            ...
            <div className="p-4 bg-accent/10 rounded-lg border hover:z-50 transition-all duration-300 hover:bg-light-pink-1 hover:shadow-xl hover:border-primary-pink active:bg-light-pink-1 active:shadow-lg active:border-primary-pink hover:scale-105 active:scale-100">
