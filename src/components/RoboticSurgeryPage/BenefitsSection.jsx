      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="hover:shadow-[0_0_15px_rgba(59,130,246,0.4)] transition-shadow duration-300 rounded-lg p-4">
              <h3 className="text-2xl font-bold mb-8 text-blue-900 flex items-center gap-2">
              ...
              <div className="space-y-4">
                {patientBenefits.map((item, idx) => (
                  <div key={idx} className="flex items-start gap-3">
                    <LuCircleCheckBig className="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
            ...
            <div className="hover:shadow-[0_0_15px_rgba(59,130,246,0.4)] transition-shadow duration-300 rounded-lg p-4">
              ...
              <div className="space-y-4">
                {surgeonBenefits.map((item, idx) => (
                  <div key={idx} className="flex items-start gap-3">
                    <LuCircleCheckBig className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                    <p className="text-gray-700">{item}</p>
                  </div>
                ))}
              </div>
