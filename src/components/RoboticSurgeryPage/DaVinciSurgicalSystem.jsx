      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {/* Card 1 */}
            <div className="bg-white text-[#b03b66] flex flex-col gap-4 rounded-xl border py-6 px-6 text-center shadow-sm transition-shadow duration-300 hover:shadow-[0_0_25px_rgba(255,197,211,0.5)]"
                 style={{ borderColor: pink }}>
              <LuMonitor className="w-12 h-12 text-[#b03b66] mx-auto mb-2" />
            ...
            <div className="bg-white text-[#b03b66] flex flex-col gap-4 rounded-xl border py-6 px-6 text-center shadow-sm transition-shadow duration-300 hover:shadow-[0_0_25px_rgba(255,197,211,0.5)]"
                 style={{ borderColor: pink }}>
              <LuActivity className="w-12 h-12 text-[#b03b66] mx-auto mb-2" />
