      ...
      >
        ...
        >
          ...
          <p className="text-sm leading-relaxed" style={{ color: "#7a2f4f" }}>
            Vulvar cancer is rare but serious. Early diagnosis leads to the best outcomes, which is
            why understanding symptoms and staying aware of changes is so important.
          </p>
        </div>
