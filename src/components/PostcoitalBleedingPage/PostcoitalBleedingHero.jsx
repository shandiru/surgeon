  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto">
        ...
        <button
          data-slot="button"
          className="inline-flex items-center justify-center gap-2 text-sm font-semibold rounded-md px-7 h-11 bg-primary-pink text-white shadow-md hover:shadow-lg hover:bg-bg-primary-pink transition-all duration-300"
        >
          <svg
