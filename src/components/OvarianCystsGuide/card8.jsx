  ...
  return (
    <div className="space-y-6 pb-10">
      <div className="max-w-sm sm:max-w-2xl lg:max-w-5xl mx-auto animate-in slide-in-from-right-5 duration-300">
        {/* ================= MAIN CARD ================= */}
        <div className="flex flex-col gap-6 rounded-xl bg-white text-black border border-primary-pink shadow-lg hover:shadow-xl transition-all duration-300 py-6 px-6 sm:px-8">
          {/* HEADER */}
