  ...
  return (
    <section className="mt-10 py-12" data-aos="fade-up">
      <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="bg-light-pink-1 text-black flex flex-col md:flex-row gap-6 rounded-xl border border-light-pink-2 border-l-4 border-l-primary-pink shadow-sm p-6">
          {/* Content Section */}
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {symptoms.map((symptom, index) => (
                ...
                >
                  ...
                  <span className="text-sm font-medium text-black">{symptom}</span>
                </div>
              ))}
            </div>
          </div>
