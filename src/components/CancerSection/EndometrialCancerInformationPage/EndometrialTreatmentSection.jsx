    ...
    <section className="mb-16 px-4 md:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-8">
          <LuShield className="h-8 w-8" style={{ color: pink }} />
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div
                  ...
                  style={{ borderColor: pink }}
                >
                  <h4 className="font-semibold mb-2" style={{ color: pink }}>Surgery</h4>
                ...
                <div
                  ...
                  style={{ borderColor: pink }}
                >
                  <h4 className="font-semibold mb-2" style={{ color: pink }}>Radiation Therapy</h4>
                  <p className="text-sm text-gray-700">
                ...
                <div
                  ...
                  style={{ borderColor: pink }}
                >
                  <h4 className="font-semibold mb-2" style={{ color: pink }}>Chemotherapy</h4>
                  <p className="text-sm text-gray-700">
              ...
              <div className="space-y-4">
                <div
                  ...
                  style={{ borderColor: pink }}
                >
                  <h4 className="font-semibold mb-2" style={{ color: pink }}>Hormone Therapy</h4>
                  <p className="text-sm text-gray-700">
                ...
                <div
                  ...
                  style={{ borderColor: pink }}
                >
                  <h4 className="font-semibold mb-2" style={{ color: pink }}>Combination Therapy</h4>
                  <p className="text-sm text-gray-700">
