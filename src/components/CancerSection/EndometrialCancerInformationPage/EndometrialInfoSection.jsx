...
export default function EndometrialInfoSection() {
  ...
  const pinkHover = "#f5a9bd";
  const pinkActive = "#e191af";
      ...
      <div className="container px-4 max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex-1 text-center md:text-left" data-aos="fade-left">
          ...
          <p className="text-lg text-black max-w-2xl mx-auto md:mx-0 mb-8">
            Early detection and understanding are key to successful treatment.
            Learn about symptoms, diagnosis, and treatment options for
            endometrial cancer.
          </p>
          ...
          <button
            ...
            onMouseDown={(e) =>
              (e.currentTarget.style.backgroundColor = pinkActive)
            }
            onMouseUp={(e) =>
              (e.currentTarget.style.backgroundColor = pinkHover)
            }
