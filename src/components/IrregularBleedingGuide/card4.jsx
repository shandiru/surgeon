            ...
            {[
              {
                ...
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg"
                    className="w-5 h-5 text-[#ff97b3]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              ...
              },
              {
                ...
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg"
                  className="w-5 h-5 text-[#ff97b3]" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
