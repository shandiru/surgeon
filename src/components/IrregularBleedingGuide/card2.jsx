  ...
  return (
    <section className="my-12 px-4">
      <main className="max-w-4xl mx-auto px-4 py-8 bg-white">
        ...
        {/* MAIN CARD */}
        <div className="bg-light-pink-1 text-[#4B0D26] flex flex-col gap-6 rounded-xl py-8 shadow-md hover:shadow-lg transition-all duration-300">
          ...
          <div className="px-6">
            <div className="grid gap-4">
              ...
              {[
                ...
                >
                  <span
                    className="inline-flex items-center justify-center rounded-md px-2 py-0.5 text-xs font-medium text-primary-pink bg-[#FFE0EB] w-fit whitespace-nowrap shrink-0"
                  >
                    {cause.tag}
                  </span>
