          ...
          <div className="rounded-lg p-6 shadow-sm bg-[#FF4B8B]/10">
            <div className="text-center">
              ...
              <div className="flex justify-center space-x-4">
                ...
                <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all shadow-sm h-9 px-4 py-2 border border-[#FF4B8B] text-[#FF4B8B]">
                  Find Support Groups
                </button>
              </div>
            </div>
