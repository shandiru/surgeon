...
const cards = [
  {
    id: 1,
    icon: <Heart className="w-10 h-10 mx-auto mb-4 text-primary-pink" />,
  ...
  {
    id: 2,
    icon: <Shield className="w-10 h-10 mx-auto mb-4 text-primary-pink" />,
  ...
  {
    id: 3,
    icon: <MessageCircle className="w-10 h-10 mx-auto mb-4 text-primary-pink" />,
    title: 'Ask Questions',
    description:
  ...
  {
    id: 4,
    icon: <Users className="w-10 h-10 mx-auto mb-4 text-primary-pink" />,
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 text-black">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Remember Section */}
          <div className="rounded-lg p-6 shadow-sm bg-primary-pink">
            <div className="text-center">
              ...
              <div className="flex justify-center space-x-4">
                <button
                  className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all shadow-sm h-9 px-4 py-2 bg-primary-pink text-white"
                >
                  Book Appointment
                </button>
                <button
                  className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all shadow-sm h-9 px-4 py-2 border border-primary-pink text-primary-pink"
                >
                  Find Support Groups
                </button>
              </div>
