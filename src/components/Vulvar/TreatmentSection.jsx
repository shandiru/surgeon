    ...
    <section id="treatment" className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
            ...
            {cards.map((card) => (
              ...
              >
                <div className="grid auto-rows-min grid-rows-[auto_auto] items-start px-6 text-center">
                  ...
                  <span className="inline-flex items-center justify-center rounded-md px-2 py-1 mt-2 text-xs font-medium whitespace-nowrap shrink-0 w-fit mx-auto bg-light-pink text-black">
                    {card.tag}
                  </span>
                </div>
                <div className="px-6">
          ...
          {/* Important Note */}
          <div className="mt-12 p-6 rounded-lg transition-all duration-300 hover:shadow-md hover:scale-[1.01] bg-light-pink">
