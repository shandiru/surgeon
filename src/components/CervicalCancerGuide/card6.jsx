      ...
      <div className="max-w-sm sm:max-w-2xl lg:max-w-5xl mx-auto rounded-2xl p-8 border shadow-sm animate-in slide-in-from-right-5 duration-300 bg-white border-light-pink-2">
        ...
        <div className="mb-6">
          ...
          <p className="text-lg mt-4 text-black">
            Treatment depends on the type, stage, and spread of the cancer — as well as your overall
            health and personal needs.
          </p>
        </div>

        {/* ================= WE CONSIDER BOX ================= */}
        <div className="p-4 rounded-lg border bg-light-pink-1 border-light-pink-2">
          ...
          <div className="grid gap-4">
            {[
              { title: "Cryosurgery", desc: "– freezing tissue to kill cancer cells" },
              {
                ...
                desc: "– removes a cone-shaped section of cervical tissue",
              },
              {
                title: "LEEP (Loop Electrosurgical Excision Procedure)",
                desc: "– removes tissue using a thin heated wire loop",
              },
              {
                title: "Hysterectomy",
                desc: "– removes the uterus and cervix; minimally invasive methods are common",
              },
              {
                title: "Total pelvic exenteration",
                desc: "– rare, for advanced cases; involves removal of reproductive organs",
              },
            ].map((item, i) => (
              <div
                key={i}
        ...
        <div className="mt-10">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {/* Radiation */}
            <div className="flex gap-3 p-4 bg-white rounded-lg border transition-all duration-300 hover:bg-light-pink-1 hover:border-light-pink-2 hover:shadow-lg border-light-pink-2">
        ...
        <div className="mt-10">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-white rounded-lg border transition-all duration-300 hover:bg-light-pink-1 hover:border-light-pink-2 hover:shadow-lg border-light-pink-2">
            ...
            <div className="p-4 bg-white rounded-lg border transition-all duration-300 hover:bg-light-pink-1 hover:border-light-pink-2 hover:shadow-lg border-light-pink-2">
              ...
              <p className="text-sm text-black">
                Oncologists, surgeons, and other specialists work together to design the best care
                plan.
              </p>
            </div>
          </div>
