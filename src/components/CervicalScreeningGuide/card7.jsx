    ...
    <div className="space-y-6 pb-14">
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center">
          {/* BOX 1 */}
          <div
            className="bg-light-pink-1 p-6 rounded-xl shadow-sm border transition
            hover:shadow-lg hover:-translate-y-2 active:scale-[0.98] border-primary-pink"
          >
            <div
              className="flex items-center justify-center w-16 h-16 mx-auto 
              rounded-full bg-primary-pink mb-3 shadow-md"
            >
              <svg
