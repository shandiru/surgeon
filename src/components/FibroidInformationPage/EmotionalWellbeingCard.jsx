  ...
  return (
    <section className="py-12 px-4 md:px-6 bg-white">
      <div className="max-w-5xl mx-auto bg-white text-black flex flex-col gap-6 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 p-8">
        ...
        {/* Highlight Box */}
        <div className="rounded-xl p-5 shadow-md hover:shadow-lg transition-all duration-200 bg-light-pink-2">
          <p className="font-medium text-center md:text-left text-primary-pink">
