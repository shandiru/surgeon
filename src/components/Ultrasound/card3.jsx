      ...
      <div className="max-w-sm sm:max-w-2xl lg:max-w-5xl text-black mx-auto mb-10 flex flex-col gap-6 rounded-xl border border-light-pink-2 py-6 shadow-sm animate-in slide-in-from-right-5 duration-300">
        ...
        <div className="px-6 space-y-4">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-4 bg-light-pink-1 rounded-lg border border-light-pink-2 hover:z-50 transition-all duration-300 hover:bg-light-pink-2 hover:shadow-xl hover:border-light-pink-2 active:bg-light-pink-2 active:shadow-lg active:border-light-pink-2 hover:scale-105 active:scale-100">
              <h4 className="font-semibold text-primary-pink mb-3 flex items-center gap-2">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={index} className="flex items-center gap-2">
                      <CircleCheck className="w-4 h-4 text-primary-pink mt-0.5 flex-shrink-0" />
            ...
            <div className="p-4 bg-light-pink-1 rounded-lg border border-light-pink-2 hover:z-50 transition-all duration-300 hover:bg-light-pink-2 hover:shadow-xl hover:border-light-pink-2 active:bg-light-pink-2 active:shadow-lg active:border-light-pink-2 hover:scale-105 active:scale-100">
              ...
              <div className="space-y-3">
                <p className="text-sm text-black">The probe is gently inserted into the vagina</p>
                <div className="space-y-2">
                  {[
