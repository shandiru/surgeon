...
const PelvicPainAlert = () => {
  ...
  return (
    <div
      role="alert"
      className="relative w-full rounded-lg  px-4 py-3 text-[#d60d64] bg-primary-pink max-w-5xl mx-auto mb-10 text-sm grid has-[&gt;svg]:grid-cols-[calc(var(--spacing)*4)_1fr] grid-cols-[0_1fr] has-[&gt;svg]:gap-x-3 gap-y-0.5 items-start [&amp;&gt;svg]:size-4 [&amp;&gt;svg]:translate-y-0.5 [&amp;&gt;svg]:text-current text-card-foreground border-destructive/50 bg-destructive/5 hover:z-50 transition-all duration-300 hover:bg-[#fce3e8] hover:shadow-lg hover:border-[#f5a9bd] active:bg-[#fce3e8] active:shadow-lg active:border-[#f5a9bd] hover:scale-105 active:scale-100"
    >
