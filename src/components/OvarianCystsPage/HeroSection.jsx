  ...
  return (
    <div className="relative overflow-hidden bg-[#FEE6EA]"> {/* removed border-b */}
      ...
      <div className="relative max-w-4xl mx-auto px-6 py-16 text-center">
        {/* Tagline */}
        <div className="inline-flex items-center gap-2 bg-primary-pink text-primary-pink px-4 py-2 rounded-full text-caption mb-6">
          <svg
        ...
        {/* Heading */}
        <h1 className="text-hero text-primary-pink mb-6">
