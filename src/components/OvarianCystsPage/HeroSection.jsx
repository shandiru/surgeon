  ...
  return (
    <div className="relative overflow-hidden bg-light-pink-1">
      ...
      <div className="relative max-w-4xl mx-auto px-6 py-16 text-center">
        {/* Tagline */}
        <div className="inline-flex items-center gap-2 bg-light-pink text-primary-pink px-4 py-2 rounded-full text-caption mb-6">
          <svg
        ...
        {/* Subtext */}
        <p className="text-body-large text-black max-w-2xl mx-auto mb-8 leading-relaxed">
