...
const HysteroscopyGuide = () => {
  ...
  return (
    <div className="text-center mb-8">
      ...
      <h1 className="text-4xl font-bold text-balance mb-4 text-[#d60d64]">Understanding Hysteroscopy</h1>
      <p className="text-xl text-muted-foreground text-balance text-[#d60d64]">What it is, why it's done, and what to expect</p>
      ...
      <div className="mt-6 max-w-md mx-auto">
        ...
        >
          <div
            ...
            className="bg-[#FF4B8B]/50 h-full w-full flex-1 transition-all"
