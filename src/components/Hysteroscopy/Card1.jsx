        ...
        <div data-slot="card-content" className="px-6 space-y-4">
          <div className="bg-primary/5 p-4 rounded-lg border border-primary/20">
            <p className="text-lg leading-relaxed">
              A hysteroscopy is a <strong>simple procedure</strong> that allows a doctor to look
              inside your uterus (womb) using a thin telescope-like camera called a hysteroscope.
            </p>
          </div>
          ...
          <div className="bg-accent/10 p-4 rounded-lg">
            ...
            <p className="text-sm">
              Hysteroscopy is commonly offered for abnormal bleeding or fertility issues. It's a
              safe way to find and treat common womb problems.
            </p>
          </div>
          ...
          <div className="pt-4">
            <button
              ...
              className="inline-flex items-center bg-[#FF4B8B] hover:bg-[#FF4B8B]/80 justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive bg-primary text-primary-foreground shadow-xs hover:bg-primary/90 h-9 px-4 py-2 has-[&_svg]:px-3 w-full"
            >
