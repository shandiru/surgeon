        ...
        <div className="px-6 space-y-4">
          <div className="space-y-4">
            ...
            <div className="flex gap-4 p-4 rounded-lg border bg-primary/5 border-primary/20">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground text-sm">
                  Use contraception between the test and your procedure (it can't be done during
                  pregnancy).
                </p>
              </div>
            </div>
          ...
          <div className="bg-accent/10 p-4 rounded-lg border border-accent/20">
            ...
            <p className="text-sm">
              ...
              case. Don't hesitate to ask questions about preparation or the procedure itself.
            </p>
          </div>
