...
import { Heart, Calendar, Activity, Target, Clock } from "lucide-react";
      ...
      <div className="max-w-5xl mx-auto animate-in slide-in-from-right-5 duration-300">
        ...
        >
          ...
          <div className="px-6 pt-6 text-center space-y-4">
            ...
            <h3 className="text-2xl font-semibold text-primary-pink">Self-Care Tips</h3>
          </div>
          ...
          <div className="px-6 mt-6 grid md:grid-cols-2 gap-4 text-black">
            ...
            <div className="space-y-3">
              {/* Track your pain */}
              <div
                className="flex items-start gap-3 p-3 bg-white/60 rounded-lg border"
                style={{ borderColor: "rgb(255,197,211)" }}
              >
