          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <p className="leading-relaxed">
                Pelvic pain is felt in the lower abdomen between the belly button and groin.  
                It can come from the reproductive organs, bladder, bowel, muscles, or connective tissue.
              </p>
