  ...
  return (
    <section className="mb-12 px-4">
      <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-light-pink-1 to-light-pink-1 text-black flex flex-col gap-6 rounded-2xl py-8 shadow-md hover:shadow-lg transition">
          <div className="px-8 pb-5 border-b border-light-pink-2">
            <div className="flex items-center gap-3 text-2xl font-bold text-primary-pink">
              Emotional Wellbeing
            </div>
          </div>
          <div className="px-8 space-y-3 text-base text-black leading-relaxed">
