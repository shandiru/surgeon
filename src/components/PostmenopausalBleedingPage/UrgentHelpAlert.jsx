...
export default function UrgentHelpAlert() {
  return (
    <section className="mb-12 px-4">
      <div
        role="alert"
        className="relative w-full rounded-2xl bg-gradient-to-r from-light-pink-1 to-light-pink-2 px-6 py-6 text-sm shadow-md hover:shadow-lg transition max-w-4xl mx-auto"
      >
        {/* Header */}
