      ...
      >
        ...
        <div className="grid auto-rows-min grid-rows-[auto_auto] items-start gap-1.5">
          ...
          <p className="text-sm" style={{ color: "#7a2f4f" }}>
            Most vaginal lumps are harmless, treatable, and not serious — but knowing the causes
            helps.
          </p>
        </div>
        ...
        <div className="space-y-4 mt-4">
          ...
          >
            ...
            <p className="text-sm" style={{ color: "#7a2f4f" }}>
              Most causes of vaginal lumps are treatable and not serious. See a doctor if a lump
              becomes painful, grows, or does not go away.
            </p>
          </div>
          ...
          <div className="pt-6 flex justify-center">
            <button
              ...
              className="inline-flex items-center bg-primary-pink hover:bg-prismary-pink/80 text-white justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all h-9 px-4 py-2 w-full cursor-pointer"
            >
