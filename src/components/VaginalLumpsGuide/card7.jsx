      ...
      >
        ...
        >
          ...
          <p className="text-sm leading-relaxed" style={{ color: "#7a2f4f" }}>
            Most vaginal lumps are harmless, but following simple prevention steps and paying
            attention to changes can help diagnose issues early — and prevent infections or
        ...
        >
          ...
          <p className="text-sm leading-relaxed" style={{ color: "#7a2f4f" }}>
            Prevention is simple: keep the area clean, avoid irritation, stay aware of changes, and
            follow up on any symptoms that don’t settle. Early management leads to quicker treatment
            and peace of mind.
          </p>
        </div>
