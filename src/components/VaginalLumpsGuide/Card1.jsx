        ...
        <div className="space-y-6">
          ...
          >
            <p className="text-lg leading-relaxed" style={{ color: "#7a2f4f" }}>
              Vaginal lumps refer to any swelling, bump, or raised area found on or inside the
              vagina. Most lumps are benign (non-cancerous) and caused by infections, blocked
              glands, or normal anatomical variations. However, persistent, painful, or growing
              lumps should always be checked by a doctor to rule out infection or, in rare cases,
              cancer.
            </p>
          </div>
