...
const VaginalLumpsGuideAbout = ({ activeButton }) => {
  const totalSteps = 8;
  ...
  return (
    <div className="text-center mb-8 px-4 sm:px-6 md:px-8 lg:px-16">
      {/* Tag and Title */}
      <div className="inline-flex bg-light-pink text-black items-center gap-2 px-4 py-2 rounded-full mb-4">
        <svg
      ...
      {/* Main Title */}
      <h1 className="text-hero text-balance mb-4 text-primary-pink">Understanding Vaginal Lumps</h1>
      <p className="text-lg sm:text-xl text-muted-foreground text-balance text-black">
...
export default VaginalLumpsGuideAbout;
