...
import { CircleAlert, CircleDashed, Circle, ChevronRight } from "lucide-react";
    ...
    <div className="space-y-6 pb-10 px-3">
      ...
      >
        ...
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold mb-3" style={{ color: "rgb(255,75,139)" }}>
        ...
        <div className="space-y-4">
          {causes.map((item, index) => (
            ...
            >
              {/* Header */}
              <div className="cursor-pointer px-6 pb-2" onClick={() => toggle(index)}>
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    {item.icon}
                    <div>
                      <div className="font-semibold text-left" style={{ color: "#FF4B8B" }}>
                        {item.title}
                      </div>
