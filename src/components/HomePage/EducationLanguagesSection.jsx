        ...
        <div className="grid lg:grid-cols-2 gap-12 items-stretch">
              ...
              {education.map((item, i) => (
                <div
                  ...
                  className="bg-white p-6 rounded-lg shadow-sm text-center lg:text-left border border-primary-pink
                             ...
                             hover:shadow-light-pink-2 active:scale-[0.98]"
                  data-aos="fade-up"
                ...
                >
                  ...
                  <p className="text-black text-body-small">{item.years}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div
            className="bg-white rounded-xl shadow-sm p-8 flex flex-col h-full border border-primary-pink
                       transition-all duration-300 hover:shadow-light-pink-2"
            data-aos="fade-left"
            data-aos-delay="300"
          >
            {/* Doctor Image */}
            <div className="flex justify-center mb-6">
              <img
                src="/new-doctor.png" //
                alt="Doctor"
                className="w-32 h-32 object-cover rounded-full border-4 border-primary-pink shadow-md"
                data-aos="zoom-in"
              />
            </div>
            ...
            <div className="text-center pb-6">
              ...
              <div className="font-semibold text-subsection text-black">
                Languages Spoken
              </div>
            </div>
                ...
                {['English', 'Hindi'].map((lang, idx) => (
                  <span
                    ...
                    className="inline-flex items-center justify-center rounded-md font-medium text-body-large px-6 py-2 
                               bg-light-pink-1 text-black border border-primary-pink 
