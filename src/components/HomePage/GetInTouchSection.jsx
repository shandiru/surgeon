    ...
    <section id="contact" className="py-20 bg-[#FFF0F4]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          {/* Card 1 - NHS Hospital */}
          <div className="bg-white flex flex-col gap-6 rounded-xl shadow-sm p-6 text-center transition-all duration-300 hover:shadow-[0_0_25px_2px_rgba(255,197,211,0.5)] hover:-translate-y-1">
