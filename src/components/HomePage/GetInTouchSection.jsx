    ...
    <section id="contact" className="py-20 bg-[#FFF0F4]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2
            className="contact-heading text-4xl font-bold text-[#FFC5D3] mb-4"
            data-aos="fade-up"
          >
            Get in Touch
          </h2>
          <p
            className="contact-subtext text-xl text-gray-700"
            data-aos="fade-up"
            data-aos-delay="200"
          >
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {cards.map((card, index) => (
            <div
              key={index}
              className="contact-card bg-white flex flex-col gap-6 rounded-xl shadow-sm p-6 text-center transition-all duration-300 hover:shadow-[0_0_25px_2px_rgba(255,197,211,0.5)] hover:-translate-y-1"
              data-aos="fade-up"
