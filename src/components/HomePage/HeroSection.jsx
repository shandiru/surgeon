      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="hero-left" data-aos="fade-up">
            ...
            <p className="hero-desc text-body-large text-black mb-8 leading-relaxed" data-aos="fade-up">
            ...
            <div className="hero-ctas flex flex-col sm:flex-row gap-4 mb-8" data-aos="fade-up">
              <a
                href="#contact"
                className="inline-flex items-center justify-center gap-2 text-button px-6 h-10 rounded-md bg-primary-pink text-white shadow-sm hover:-translate-y-0.5 transition-all"
              >
              ...
              <a
                href="#about"
                className="inline-flex items-center justify-center gap-2 text-button px-6 h-10 rounded-md border border-primary-pink text-primary-pink hover:bg-light-pink-2 hover:-translate-y-0.5 transition-all"
              >
                Learn More
                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  <path d="M5 12h14" />
            ...
            <div className="hero-icons flex items-center gap-6 text-body-small " data-aos="fade-up">
          ...
          <div className="relative hero-right" data-aos="fade-left">
            <div className="bg-white rounded-2xl shadow-xl p-6 relative transition-all duration-300 hover:shadow-[0_0_30px_4px_rgba(255,75,139,0.4)] hover:-translate-y-1">
              ...
              />
              <div className="hero-bubble absolute -bottom-4 -right-4 bg-primary-pink text-white px-4 py-3 rounded-xl shadow-md" data-aos="fade-up">
