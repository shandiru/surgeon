      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {cards.map((card, i) => (
            <div
              key={i}
              className="group bg-white text-black flex flex-col gap-6 rounded-xl border border-primary-pink shadow-sm text-center p-6 transition-all duration-300 
            ...
            >
              <div className="bg-light-pink-1 group-hover:bg-light-pink-2 transition-colors duration-300 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg
