    ...
    <section className="py-20 bg-white" id="about">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          {/* Card 1 */}
          <div className="bg-white text-gray-900 flex flex-col gap-6 rounded-xl border shadow-sm text-center p-6">
            <div className="bg-[#c3eefa]/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#5a9bb8]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
