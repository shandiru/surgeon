  ...
  return (
    <section id="experience" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Hospital Cards */}
        <div className="grid sm:grid-cols-2 gap-6 mb-16 max-w-3xl mx-auto lg:max-w-none">
          {[
            {
            ...
            <div
              ...
              className="bg-white flex flex-col gap-4 rounded-xl border border-primary-pink/10 shadow-sm p-6 transition-all duration-300
                         hover:shadow-[0_0_30px_4px_rgba(255,75,139,0.15)] hover:scale-[1.02] active:scale-[0.99] w-full"
              data-aos="fade-up"
