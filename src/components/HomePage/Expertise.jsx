...
export default function SpecialtiesSection() {
  ...
  return (
    <section id="specialties" className="bg-white py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Primary Specialties */}
        <div
          className="bg-white rounded-2xl p-8 mb-12 shadow-sm border border-primary-pink"
          data-aos="fade-up"
          data-aos-delay="150"
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {specialties.map((item, idx) => (
              <div
                key={idx}
                className="text-center group transition-all duration-300 hover:scale-[1.05] hover:shadow-[0_0_25px_2px_rgba(255,75,139,0.25)] rounded-xl p-4 bg-light-pink-1"
                data-aos="fade-up"
              ...
              >
                ...
                <h3 className="font-semibold mb-1 text-body-small text-black">
                  {item.title}
                </h3>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Surgical */}
          <div
            className="bg-white rounded-xl border border-primary-pink shadow-sm p-6 flex flex-col gap-6 transition-all duration-300 hover:shadow-[0_0_25px_2px_rgba(255,75,139,0.25)]"
            data-aos="fade-up"
          >
            ...
            <ul className="space-y-4">
              {surgicalExpertise.map((item, idx) => (
                <li key={idx} className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-body text-black">
                      {item.title}
                    </div>
