        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex ml-10 space-x-1 items-center relative">
            <HashLink
              smooth
              to="/#about"
              className="text-gray-600 hover:text-gray-900 px-1 py-2 text-nav"
            >
              About
            </HashLink>
            <HashLink
            ...
            <HashLink
              smooth
              to="/#contact"
              className="text-gray-600 hover:text-gray-900 px-1 py-2 text-sm font-medium"
            >
              Contact
            </HashLink>
          </div>
            ...
            <div className="relative">
              ...
              {isServicesOpen && (
                <div className="ml-4 mt-1 space-y-1">
                  <Link
                    to="/Cancer/Vulvar"
                    className="block px-3 py-2 text-body-small text-black hover:bg-primary-pint"
                    onClick={closeDropdowns}
                  >
                    Vulvar Cancer
                  </Link>
                  ...
                  <Link
                    to="/CervicalScreening"
                    className="block px-4 py-2 text-body-small text-black hover:bg-primary-pint"
                    onClick={closeDropdowns}
                  >
                    Cervical Screening
                  </Link>
