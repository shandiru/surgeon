...
const VulvarGuideAbout = ({ activeButton }) => {
  ...
  return (
    <div className="text-center mb-8 px-4 sm:px-6 md:px-8 lg:px-16">
      {/* Tag and Title */}
      <div className="inline-flex bg-light-pink-2 text-black items-center gap-2 px-4 py-2 rounded-full mb-4">
        <svg
      ...
      {/* Main Title */}
      <h1 className="text-hero text-balance mb-4 text-primary-pink">Understanding Vulvar Cancer</h1>
...
export default VulvarGuideAbout;
