    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          {/* Fertility Impact */}
          <div className="bg-white text-black rounded-2xl p-8 shadow-lg transition duration-300 
          hover:shadow-[0_0_25px_rgba(176,59,102,0.4)] hover:-translate-y-2 active:scale-[0.98]">
            <div className="flex items-center gap-3 mb-4">
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-primary-pink">
                <svg
