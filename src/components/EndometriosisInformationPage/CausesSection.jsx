        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {causes.map((item, index) => (
            <div
              ...
              transition duration-300 hover:shadow-xl hover:-translate-y-2 active:scale-[0.98]"
            >
              {/* Icon */}
              <div className="w-14 h-14 bg-light-pink-1 rounded-full flex items-center justify-center mb-4">
