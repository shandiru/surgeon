  ...
  const renderContent = () => {
      ...
      return (
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {imageBlocks.length > 0 && (
            <div>{renderBlocks(imageBlocks)}</div>
          )}
        </div>
      );
    }
    ...
    return (
      <div className="space-y-6 px-2 sm:px-4 lg:px-8">
        <h2 className="text-3xl md:text-4xl font-bold text-[#FF4B8B] [text-wrap:balance] text-center">
          {section.cardTitle}
        </h2>
      ...
      >
        ...
        <div className="pt-6 flex justify-center">
          {!isLastSection ? (
            ...
            <div className="text-center text-[#BB125B] font-semibold text-lg">
              Guide Complete
            </div>
          )}
        </div>
