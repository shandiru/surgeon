...
function FirstAppointmentSection() {
  return (
    <section>
      <SectionHeader Icon={Stethoscope} title="What to Expect at Your First Appointment" />
      <p className="text-body text-gray-600 mb-6 leading-relaxed">
        Your first consultation provides an opportunity to discuss your symptoms, concerns and medical
        history in detail. The aim is to understand your condition fully and explore appropriate
        investigation or treatment options.
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 hover:shadow-[0_0_25px_3px_rgba(255,75,139,0.12)] hover:-translate-y-1 transition-all duration-300">
          <h3 className="text-base font-semibold text-gray-900 mb-4">During your consultation</h3>
        ...
        <div className="bg-light-pink-1 rounded-xl p-6 hover:bg-light-pink-2 hover:-translate-y-1 transition-all duration-300">
          <h3 className="text-base font-semibold text-gray-900 mb-4">After your consultation</h3>
          <p className="text-sm text-gray-700 leading-relaxed mb-4">
            In some cases, additional tests or imaging may be recommended to help clarify the
            diagnosis. These may include:
          </p>
          <ul className="space-y-3">
            {["Blood tests", "Ultrasound scans", "Further specialist investigations"].map((item) => (
              <BulletItem key={item} text={item} />
            ))}
          </ul>
          <p className="text-sm text-gray-600 mt-4 leading-relaxed">
            A detailed clinic letter summarising the consultation and recommendations will normally
...
function ConsultationPrepSection() {
  const questions = [
    { label: "What symptoms or problems are you experiencing?", multiline: true },
    { label: "When did these symptoms start and how have they changed over time?", multiline: false },
    { label: "Have you already tried any treatments or medications?", multiline: false },
    { label: "Medications you currently take:", multiline: false },
    { label: "Previous operations:", multiline: false },
    { label: "Do you have any test results, scans or clinic letters to bring?", multiline: false },
    { label: "What would you like help with from this consultation?", multiline: true },
  ];
  ...
  return (
    <section>
      <SectionHeader Icon={ClipboardList} title="Consultation Preparation Notes" />
      <p className="text-body text-gray-600 mb-6 leading-relaxed">
        Many patients find it helpful to prepare some notes before their appointment. Fill in the
        template below and download it as a PDF to bring to your consultation.
      </p>

      <div
        className="bg-white border-2 border-dashed border-primary-pink/40 rounded-xl p-8 shadow-sm"
      >
        {/* Template header */}
        <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-200">
          <div>
            ...
            <p className="text-xs text-gray-400">Mr Ketankumar Gajjar — Gynaecological Oncologist</p>
          </div>
      ...
      <div className="mt-6">
        ...
        <p className="text-xs text-gray-400 mt-3">
          Please note: consultations are usually designed to assess one main condition at a time.
          If you have several concerns, you may wish to request additional consultation time.
        </p>
      </div>
    </section>
  );
...
function FeesInsuranceSection() {
  return (
    <section>
      ...
      <p className="text-body text-gray-600 mb-6 leading-relaxed">
        Consultations and procedures are available for both self-funding patients and those with
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-6">
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 hover:shadow-[0_0_25px_3px_rgba(255,75,139,0.12)] hover:-translate-y-1 transition-all duration-300">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-base font-semibold text-gray-900">Insured Patients</h3>
          </div>
          <p className="text-sm text-gray-600 mb-4 leading-relaxed">
            If you have private medical insurance, please check with your insurer before your
            appointment to confirm that your consultation and any investigations or treatment are
        ...
        <div className="bg-light-pink-1 rounded-xl p-6 hover:bg-light-pink-2 hover:-translate-y-1 transition-all duration-300">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-base font-semibold text-gray-900">Self-Funding Patients</h3>
          </div>
          <p className="text-sm text-gray-600 mb-4 leading-relaxed">
            Self-funding patients are very welcome. Information regarding consultation fees and
            procedure costs can be provided by the clinic team on request.
          </p>
          <div className="bg-white/70 rounded-lg p-4 text-sm text-gray-600 leading-relaxed">
            <strong className="text-gray-800 block mb-1">Please note:</strong>
            Hospital charges, anaesthetist fees and investigation costs may be billed separately
...
function ConditionsTreatedSection() {
  const groups = [
    {
      ...
      items: ["Ovarian cancer", "Endometrial (uterine) cancer", "Cervical cancer", "Vulval cancer"],
    },
    {
  ...
  return (
    <section>
      ...
      <p className="text-body text-gray-600 mb-6 leading-relaxed">
        I provide assessment and treatment for a wide range of gynaecological conditions. Each
        patient is assessed individually and treatment recommendations are tailored to the specific
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {groups.map(({ title, items }) => (
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-base font-semibold text-primary-pink mb-4">{title}</h3>
...
function FollowUpCareSection() {
  return (
    <section>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 hover:shadow-[0_0_25px_3px_rgba(255,75,139,0.12)] hover:-translate-y-1 transition-all duration-300">
          <h3 className="text-base font-semibold text-gray-900 mb-3">Post-procedure Follow-up</h3>
          <p className="text-sm text-gray-600 leading-relaxed mb-4">
            Ongoing care and support are an important part of treatment. After your procedure or
            treatment, follow-up appointments will be arranged to:
          </p>
          <ul className="space-y-3">
            {[
          ...
          <p className="text-sm text-gray-500 mt-4 italic">
            Follow-up schedules are personalised depending on your condition and treatment.
          </p>
        </div>

        <div className="bg-light-pink-1 rounded-xl p-6 hover:bg-light-pink-2 hover:-translate-y-1 transition-all duration-300">
          <h3 className="text-base font-semibold text-gray-900 mb-3">Cancer Follow-up</h3>
          <p className="text-sm text-gray-600 leading-relaxed mb-4">
            For patients treated for gynaecological cancers, follow-up focuses on monitoring
            recovery, long-term health and addressing any concerns that may arise over time.
          </p>
          <div className="bg-white/70 rounded-lg p-4">
            <h4 className="text-sm font-semibold text-gray-800 mb-2">Coordinated Care</h4>
            <p className="text-sm text-gray-600 leading-relaxed">
              I work closely with your GP and other specialists to ensure coordinated care and
              continuity of treatment throughout your journey.
            </p>
          </div>
        </div>
      </div>
    ...
    <section>
      ...
      <div className="bg-gradient-to-r from-light-pink-1 to-white rounded-2xl p-8 hover:shadow-[0_0_25px_3px_rgba(255,75,139,0.12)] transition-all duration-300">
        <p className="text-body text-gray-600 leading-relaxed mb-8">
          In addition to medical and surgical treatment, supportive care is an important part of
          the patient journey.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-base font-semibold text-gray-900">Specialist Nurse Support</h3>
            </div>
            <p className="text-sm text-gray-600 leading-relaxed">
              Patients may have access to specialist nurse support who can provide guidance, answer
              questions and assist with coordination of care during treatment and recovery.
            </p>
          </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-base font-semibold text-gray-900">Wellbeing Support</h3>
            </div>
  ...
  return (
    <section>
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-8 hover:shadow-[0_0_25px_3px_rgba(255,75,139,0.12)] hover:-translate-y-1 transition-all duration-300">
        <p className="text-body text-gray-600 leading-relaxed mb-8">
          Surgery is carried out with the support of experienced anaesthetists and specialist theatre
          staff who are familiar with advanced gynaecological procedures. Working together as a
          coordinated team helps ensure safe surgery and high standards of patient care throughout
          the operative and recovery process.
        </p>

        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {[
            { label: "Consultant Anaesthetists", desc: "Specialist pain and sedation care" },
            { label: "Scrub Nurses", desc: "Expert instrument and sterile field management" },
            { label: "Recovery Team", desc: "Dedicated post-operative monitoring and support" },
          ].map(({ label, desc }) => (
            <div
              key={label}
            ...
            >
              <p className="text-sm font-semibold text-primary-pink mb-1">{label}</p>
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-[#FDE7EB] py-20 md:py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="inline-block border border-primary-pink text-primary-pink text-xs font-semibold px-4 py-1.5 rounded-full mb-5" data-aos="fade-down">
            Mr Ketankumar Gajjar
          </span>
          <h1 className="text-hero text-gray-900 mb-4 leading-tight" data-aos="fade-up">
            Patient <span className="text-primary-pink">Centre</span>
          </h1>
          <p className="text-body-large text-black/70 max-w-2xl mx-auto leading-relaxed" data-aos="fade-up" data-aos-delay="100">
            Everything you need to know before, during and after your care — from your first
            appointment to follow-up and beyond.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="flex gap-10 items-start">
          ...
          <main className="flex-1 min-w-0" data-aos="fade-up" key={activeSection}>
            <ActiveComponent />
          </main>
        </div>
      </div>
      ...
      <section className="bg-primary-pink py-16 px-4">
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          <p className="text-white/80 mb-8 text-base">
            Book a consultation with Mr Ketankumar Gajjar to discuss your symptoms, concerns or
            treatment options in a compassionate, expert setting.
          </p>
          <a
            href="/#contact"
